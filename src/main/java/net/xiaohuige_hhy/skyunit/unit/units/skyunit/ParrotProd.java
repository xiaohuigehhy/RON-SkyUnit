...
public class ParrotProd extends ProductionItem {
	...
	public final static ResourceCost cost = SkyUnitResourceCosts.PARROT;
	...
	public UnitSpawnButton getPlaceButton() {
		return new UnitSpawnButton(
			...
			List.of(
				FormattedCharSequence.forward(I18n.get("units.skyunit.parrot"), Style.EMPTY.withBold(true)),
				FormattedCharSequence.forward("", Style.EMPTY),
				FormattedCharSequence.forward(I18n.get("units.skyunit.parrot.tooltip1"), Style.EMPTY),
				FormattedCharSequence.forward(I18n.get("units.skyunit.parrot.tooltip2"), Style.EMPTY)
			)
		);
	}
